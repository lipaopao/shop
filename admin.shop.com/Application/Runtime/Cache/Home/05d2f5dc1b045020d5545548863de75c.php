        ...
        <form enctype="multipart/form-data" action="<?php echo U('add');?>" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="sn" value="<?php echo ($sn); ?>" size="20"/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name='logo' value="<?php echo ($row["logo"]); ?>" id='logourl'/>
                        <img src='<?php echo ($row["logo"]); ?>' id='logopreview' style='max-width: 80px;max-height: 60px;margin-top:10px'/>
                    </td>
                </tr>
                <tr>
