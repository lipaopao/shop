...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            .explode {
                background:url(http://admin.shop.com/Public/Home/Images/menu_minus.gif) no-repeat 0px 3px;
                font-weight:bold;
            }
            .collapse {
                background:url(http://admin.shop.com/Public/Home/Images/menu_plus.gif) no-repeat 0px 3px;
                font-weight:bold;
            }
            .menu-item {
                background:url(http://admin.shop.com/Public/Home/Images/menu_arrow.gif) no-repeat 0px 3px;
                font-weight:normal;
            }
            #help-title {
                font-size:14px;
    ...
    <body>
            ...
            <p>
                <span style="float:right; padding:3px 5px;" >
                    <a href="javascript:toggleCollapse();">
                        <img id="toggleImg" src="http://admin.shop.com/Public/Home/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
                    </a>
                </span>
            ...
            <div id="menu-list">
                <ul id="menu-ul">
                    <?php if(is_array($menus)): foreach($menus as $key=>$top): if(($top["parent_id"]) == "0"): ?><li class="explode" name="menu">
                                <?php echo ($top["name"]); ?>
                                <ul>
                                    <?php if(is_array($menus)): foreach($menus as $key=>$second): if(($second["parent_id"]) == $top["id"]): ?><li class="menu-item"><a href="<?php echo U($second['path']);?>" target="main-frame"><?php echo ($second["name"]); ?></a></li><?php endif; endforeach; endif; ?>
                                </ul>
        ...
        <script type="text/javascript" src="http://admin.shop.com/Public/Home/Js/global.js"></script>
        <script type="text/javascript" src="http://admin.shop.com/Public/Home/Js/utils.js"></script>
        <script type="text/javascript" src="http://admin.shop.com/Public/Home/Js/transport.js"></script>
        <script language="JavaScript">
            ...
            function toggleCollapse() {
                ...
                collapse = !collapse;
                document.getElementById('toggleImg').src = collapse ? 'http://admin.shop.com/Public/Home/Images/menu_minus.gif' : 'http://admin.shop.com/Public/Home/Images/menu_plus.gif';
