        ...
        <div class="main-div">
            <form action="<?php echo U();?>" method="post" name="theForm" enctype="multipart/form-data">
                <table width="100%" id="general-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(is_array($rows)): foreach($rows as $key=>$r): ?><option value="<?php echo ($r["id"]); ?>"><?php echo str_repeat('&nbsp;',($r['level']-1)*5); echo ($r["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="button-div">
                    <input type="hidden" value="<?php echo ($r["parent_id"]); ?>" name="id"/>
