...
<form method="post" action="<?php echo U();?>">
    <table cellspacing="0" cellpadding="0" style="margin-top:100px" align="center">
        <tr>
            <td>
                <img src="http://admin.shop.com/Public/Home/Images/login.png" width="178" height="256" border="0" alt="ECSHOP" />
            </td>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img src="<?php echo U('show');?>" style='max-width: 146px' class='captcha'/>
                        </td>
                    </tr>
                    <tr>
    ...
    <script type='text/javascript'>
        $(function(){
            $('.captcha').click(function(){
                $(this).attr('src','<?php echo U("Captcha/show");?>?nocache='+new Date().getTime());
            });
        });
    </script>
</body>